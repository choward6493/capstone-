    ...
    */
    ...
    <body>
        ...
        <div class="topnav">
            ...
            <button id="logB" display="inline" class="login" onclick="document.getElementById('id01').style.display='block'" style="display:none;width:auto;float:right;font-family: Arial;">Login</button>
